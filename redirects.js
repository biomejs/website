...
export default {
  ...
  '/assist/actions/useSortedEnumMembers': '/assist/actions/use-sorted-enum-members',
  ...
  '/assist/actions/useSortedPackageJson': '/assist/actions/use-sorted-package-json',
  '/assist/actions/useSortedProperties': '/assist/actions/use-sorted-properties',
  '/assist/actions/useSortedSelectionSet': '/assist/actions/use-sorted-selection-set',
  '/assist/actions/useSortedTypeFields': '/assist/actions/use-sorted-type-fields',
  ...
  '/linter/rules/noBaseToString': '/linter/rules/no-base-to-string',
  ...
  '/linter/rules/noComponentHookFactories': '/linter/rules/no-component-hook-factories',
  ...
  '/linter/rules/noDuplicateSelectors': '/linter/rules/no-duplicate-selectors',
  ...
  '/linter/rules/noEmptyObjectKeys': '/linter/rules/no-empty-object-keys',
  ...
  '/linter/rules/noExtendNative': '/linter/rules/no-extend-native',
  ...
  '/linter/rules/noIdenticalTestTitle': '/linter/rules/no-identical-test-title',
  ...
  '/linter/rules/noLoopFunc': '/linter/rules/no-loop-func',
  ...
  '/linter/rules/noMisleadingReturnType': '/linter/rules/no-misleading-return-type',
  ...
  '/linter/rules/noMultilineString': '/linter/rules/no-multiline-string',
  ...
  '/linter/rules/noNonScalableViewport': '/linter/rules/no-non-scalable-viewport',
  ...
  '/linter/rules/noReactNativeDeepImports': '/linter/rules/no-react-native-deep-imports',
  '/linter/rules/noReactNativeLiteralColors': '/linter/rules/no-react-native-literal-colors',
  ...
  '/linter/rules/noReactStringRefs': '/linter/rules/no-react-string-refs',
  ...
  '/linter/rules/noRestrictedDependencies': '/linter/rules/no-restricted-dependencies',
  ...
  '/linter/rules/noSvelteLegacyConst': '/linter/rules/no-svelte-legacy-const',
  ...
  '/linter/rules/noTopLevelLiterals': '/linter/rules/no-top-level-literals',
  ...
  '/linter/rules/noUndeclaredClasses': '/linter/rules/no-undeclared-classes',
  ...
  '/linter/rules/noUnnecessaryTemplateExpression': '/linter/rules/no-unnecessary-template-expression',
  ...
  '/linter/rules/noUnsafePlusOperands': '/linter/rules/no-unsafe-plus-operands',
  '/linter/rules/noUnsafeTypeAssertion': '/linter/rules/no-unsafe-type-assertion',
  '/linter/rules/noUntrustedLicenses': '/linter/rules/no-untrusted-licenses',
  '/linter/rules/noUnusedClasses': '/linter/rules/no-unused-classes',
  ...
  '/linter/rules/noUnusedInstantiation': '/linter/rules/no-unused-instantiation',
  ...
  '/linter/rules/noVueImportCompilerMacros': '/linter/rules/no-vue-import-compiler-macros',
  ...
  '/linter/rules/noVueVOnNumberValues': '/linter/rules/no-vue-v-on-number-values',
  ...
  '/linter/rules/useArrayFind': '/linter/rules/use-array-find',
  ...
  '/linter/rules/useBaseline': '/linter/rules/use-baseline',
  ...
  '/linter/rules/useDisposables': '/linter/rules/use-disposables',
  '/linter/rules/useDomNodeTextContent': '/linter/rules/use-dom-node-text-content',
  '/linter/rules/useDomQuerySelector': '/linter/rules/use-dom-query-selector',
  ...
  '/linter/rules/useExplicitReturnType': '/linter/rules/use-explicit-return-type',
  ...
  '/linter/rules/useIframeSandbox': '/linter/rules/use-iframe-sandbox',
  ...
  '/linter/rules/useImportsFirst': '/linter/rules/use-imports-first',
  '/linter/rules/useIncludes': '/linter/rules/use-includes',
  ...
  '/linter/rules/useMathMinMax': '/linter/rules/use-math-min-max',
  ...
  '/linter/rules/useReactCompiler': '/linter/rules/use-react-compiler',
  '/linter/rules/useReactFunctionComponentDefinition': '/linter/rules/use-react-function-component-definition',
  ...
  '/linter/rules/useSpreadOverApply': '/linter/rules/use-spread-over-apply',
  ...
  '/linter/rules/useThisInClassMethods': '/linter/rules/use-this-in-class-methods',
  ...
  '/linter/rules/useUnicodeRegex': '/linter/rules/use-unicode-regex',
  ...
  '/linter/rules/useVarsOnTop': '/linter/rules/use-vars-on-top',
  ...
  '/linter/rules/useVueNextTickPromise': '/linter/rules/use-vue-next-tick-promise',
