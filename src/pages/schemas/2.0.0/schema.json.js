	...
	const schema = {
		...
		definitions: {
			...
			AssistConfiguration: {
				...
				properties: {
					...
					includes: {
						...
						items: {
							$ref: "#/definitions/NormalizedGlob",
						},
					},
				},
				additionalProperties: false,
			...
			CustomRestrictedImport: {
				anyOf: [
					...
					},
					{
						...
						allOf: [
							{
								$ref: "#/definitions/CustomRestrictedImportOptions",
							},
						],
					},
				],
			...
			Modifiers: {
				type: "array",
				items: {
					$ref: "#/definitions/RestrictedModifier",
				},
				uniqueItems: true,
			},
			...
			Overrides: {
				type: "array",
				items: {
					$ref: "#/definitions/OverridePattern",
				},
			},
			Performance: {
				description: "A list of rules that belong to this group",
			...
			RuleWithComplexityOptions: {
				...
				properties: {
					...
					options: {
						...
						allOf: [
							{
								$ref: "#/definitions/ComplexityOptions",
							},
						],
					},
				},
			...
			RuleWithConsistentArrayTypeOptions: {
				...
				properties: {
					...
					options: {
						...
						allOf: [
							{
								$ref: "#/definitions/ConsistentArrayTypeOptions",
							},
						],
					},
				},
			...
			RuleWithDeprecatedHooksOptions: {
				...
				properties: {
					...
					options: {
						...
						allOf: [
							{
								$ref: "#/definitions/DeprecatedHooksOptions",
							},
						],
					},
				},
			...
			RuleWithFilenamingConventionOptions: {
				...
				properties: {
					...
					options: {
						...
						allOf: [
							{
								$ref: "#/definitions/FilenamingConventionOptions",
							},
						],
					},
				},
			...
			RuleWithImportTypeOptions: {
				...
				properties: {
					...
					options: {
						...
						allOf: [
							{
								$ref: "#/definitions/ImportTypeOptions",
							},
						],
					},
				},
			...
			RuleWithNamingConventionOptions: {
				...
				properties: {
					...
					options: {
						...
						allOf: [
							{
								$ref: "#/definitions/NamingConventionOptions",
							},
						],
					},
				},
			...
			RuleWithNoBitwiseOperatorsOptions: {
				...
				properties: {
					...
					options: {
						...
						allOf: [
							{
								$ref: "#/definitions/NoBitwiseOperatorsOptions",
							},
						],
					},
				},
			...
			RuleWithNoConfusingLabelsOptions: {
				...
				properties: {
					...
					options: {
						...
						allOf: [
							{
								$ref: "#/definitions/NoConfusingLabelsOptions",
							},
						],
					},
				},
			...
			RuleWithNoForEachOptions: {
				...
				properties: {
					...
					options: {
						...
						allOf: [
							{
								$ref: "#/definitions/NoForEachOptions",
							},
						],
					},
				},
			...
			RuleWithNoLabelWithoutControlOptions: {
				...
				properties: {
					...
					options: {
						...
						allOf: [
							{
								$ref: "#/definitions/NoLabelWithoutControlOptions",
							},
						],
					},
				},
			...
			RuleWithNoPrivateImportsOptions: {
				...
				properties: {
					...
					options: {
						...
						allOf: [
							{
								$ref: "#/definitions/NoPrivateImportsOptions",
							},
						],
					},
				},
			...
			RuleWithNoRestrictedElementsOptions: {
				...
				properties: {
					...
					options: {
						...
						allOf: [
							{
								$ref: "#/definitions/NoRestrictedElementsOptions",
							},
						],
					},
				},
			...
			RuleWithNoSecretsOptions: {
				...
				properties: {
					...
					options: {
						...
						allOf: [
							{
								$ref: "#/definitions/NoSecretsOptions",
							},
						],
					},
				},
			...
			RuleWithNoUndeclaredDependenciesOptions: {
				...
				properties: {
					...
					options: {
						...
						allOf: [
							{
								$ref: "#/definitions/NoUndeclaredDependenciesOptions",
							},
						],
					},
				},
			...
			RuleWithRestrictedGlobalsOptions: {
				...
				properties: {
					...
					options: {
						...
						allOf: [
							{
								$ref: "#/definitions/RestrictedGlobalsOptions",
							},
						],
					},
				},
			...
			RuleWithRestrictedImportsOptions: {
				...
				properties: {
					...
					options: {
						...
						allOf: [
							{
								$ref: "#/definitions/RestrictedImportsOptions",
							},
						],
					},
				},
			...
			RuleWithUndeclaredVariablesOptions: {
				...
				properties: {
					...
					options: {
						...
						allOf: [
							{
								$ref: "#/definitions/UndeclaredVariablesOptions",
							},
						],
					},
				},
			...
			RuleWithUseJsxKeyInIterableOptions: {
				...
				properties: {
					...
					options: {
						...
						allOf: [
							{
								$ref: "#/definitions/UseJsxKeyInIterableOptions",
							},
						],
					},
				},
			...
			RuleWithUseValidAutocompleteOptions: {
				...
				properties: {
					...
					options: {
						...
						allOf: [
							{
								$ref: "#/definitions/UseValidAutocompleteOptions",
							},
						],
					},
				},
			...
			RuleWithUtilityClassSortingOptions: {
				...
				properties: {
					...
					options: {
						...
						allOf: [
							{
								$ref: "#/definitions/UtilityClassSortingOptions",
							},
						],
					},
				},
			...
			RuleWithValidAriaRoleOptions: {
				...
				properties: {
					...
					options: {
						...
						allOf: [
							{
								$ref: "#/definitions/ValidAriaRoleOptions",
							},
						],
					},
				},
