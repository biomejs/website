		...
		definitions: {
			...
			HtmlConfiguration: {
				...
				properties: {
					assist: {
						anyOf: [
							{ $ref: "#/definitions/HtmlAssistConfiguration" },
							{ type: "null" },
						],
					},
					...
					linter: {
						...
						anyOf: [
							{ $ref: "#/definitions/HtmlLinterConfiguration" },
							{ type: "null" },
						],
					},
					parser: {
			...
			NoDeprecatedImportsConfiguration: {
				anyOf: [
					{ $ref: "#/definitions/RulePlainConfiguration" },
					{ $ref: "#/definitions/RuleWithNoDeprecatedImportsOptions" },
				],
			},
			...
			NoEmptySourceConfiguration: {
				anyOf: [
					{ $ref: "#/definitions/RulePlainConfiguration" },
					{ $ref: "#/definitions/RuleWithNoEmptySourceOptions" },
				],
			},
			...
			NoIncrementDecrementConfiguration: {
				anyOf: [
					{ $ref: "#/definitions/RulePlainConfiguration" },
					{ $ref: "#/definitions/RuleWithNoIncrementDecrementOptions" },
				],
			},
			...
			NoJsxLiteralsConfiguration: {
				anyOf: [
					{ $ref: "#/definitions/RulePlainConfiguration" },
					{ $ref: "#/definitions/RuleWithNoJsxLiteralsOptions" },
				],
			},
			...
			NoParameterAssignOptions: {
				...
				properties: {
					propertyAssignment: {
						...
						anyOf: [
							{ $ref: "#/definitions/PropertyAssignmentMode" },
							{ type: "null" },
						],
					},
				},
			...
			NoParametersOnlyUsedInRecursionConfiguration: {
				anyOf: [
					{ $ref: "#/definitions/RulePlainConfiguration" },
					{
						$ref: "#/definitions/RuleWithNoParametersOnlyUsedInRecursionOptions",
					},
				],
			},
			...
			NoPrivateImportsOptions: {
				...
				properties: {
					defaultVisibility: {
						...
						anyOf: [{ $ref: "#/definitions/Visibility" }, { type: "null" }],
					},
				},
				additionalProperties: false,
			},
			...
			NoReactForwardRefConfiguration: {
				anyOf: [
					{ $ref: "#/definitions/RulePlainConfiguration" },
					{ $ref: "#/definitions/RuleWithNoReactForwardRefOptions" },
				],
			},
			...
			NoRestrictedElementsOptions: {
				...
				properties: {
					elements: {
						...
						anyOf: [
							{ $ref: "#/definitions/CustomRestrictedElements" },
							{ type: "null" },
						],
					},
				},
			...
			NoUndeclaredDependenciesOptions: {
				...
				properties: {
					devDependencies: {
						...
						anyOf: [
							{ $ref: "#/definitions/DependencyAvailability" },
							{ type: "null" },
						],
					},
			...
			NoUnknownAttributeConfiguration: {
				anyOf: [
					{ $ref: "#/definitions/RulePlainConfiguration" },
					{ $ref: "#/definitions/RuleWithNoUnknownAttributeOptions" },
				],
			},
			...
			NoUnusedExpressionsConfiguration: {
				anyOf: [
					{ $ref: "#/definitions/RulePlainConfiguration" },
					{ $ref: "#/definitions/RuleWithNoUnusedExpressionsOptions" },
				],
			},
			...
			NoUselessCatchBindingConfiguration: {
				anyOf: [
					{ $ref: "#/definitions/RulePlainConfiguration" },
					{ $ref: "#/definitions/RuleWithNoUselessCatchBindingOptions" },
				],
			},
			...
			NoVueDuplicateKeysConfiguration: {
				anyOf: [
					{ $ref: "#/definitions/RulePlainConfiguration" },
					{ $ref: "#/definitions/RuleWithNoVueDuplicateKeysOptions" },
				],
			},
			...
			Nursery: {
				...
				properties: {
					...
					noDeprecatedImports: {
						...
						anyOf: [
							{ $ref: "#/definitions/NoDeprecatedImportsConfiguration" },
							{ type: "null" },
						],
					},
					...
					noEmptySource: {
						...
						anyOf: [
							{ $ref: "#/definitions/NoEmptySourceConfiguration" },
							{ type: "null" },
						],
					},
					noFloatingPromises: {
					...
					noIncrementDecrement: {
						...
						anyOf: [
							{ $ref: "#/definitions/NoIncrementDecrementConfiguration" },
							{ type: "null" },
						],
					},
					noJsxLiterals: {
						...
						anyOf: [
							{ $ref: "#/definitions/NoJsxLiteralsConfiguration" },
							{ type: "null" },
						],
					},
					noMisusedPromises: {
					...
					noParametersOnlyUsedInRecursion: {
						...
						anyOf: [
							{
								$ref: "#/definitions/NoParametersOnlyUsedInRecursionConfiguration",
							},
							{ type: "null" },
						],
					},
					...
					noUnknownAttribute: {
						...
						anyOf: [
							{ $ref: "#/definitions/NoUnknownAttributeConfiguration" },
							{ type: "null" },
						],
					},
					...
					noUnusedExpressions: {
						...
						anyOf: [
							{ $ref: "#/definitions/NoUnusedExpressionsConfiguration" },
							{ type: "null" },
						],
					},
					noUselessCatchBinding: {
						...
						anyOf: [
							{ $ref: "#/definitions/NoUselessCatchBindingConfiguration" },
							{ type: "null" },
						],
					},
					noUselessUndefined: {
					...
					noVueDuplicateKeys: {
						...
						anyOf: [
							{ $ref: "#/definitions/NoVueDuplicateKeysConfiguration" },
							{ type: "null" },
						],
					},
					noVueReservedKeys: {
					...
					useArraySortCompare: {
						...
						anyOf: [
							{ $ref: "#/definitions/UseArraySortCompareConfiguration" },
							{ type: "null" },
						],
					},
					useConsistentArrowReturn: {
						...
						anyOf: [
							{ $ref: "#/definitions/UseConsistentArrowReturnConfiguration" },
							{ type: "null" },
						],
					},
					useDeprecatedDate: {
					...
					useQwikMethodUsage: {
						...
						anyOf: [
							{ $ref: "#/definitions/UseQwikMethodUsageConfiguration" },
							{ type: "null" },
						],
					},
					useQwikValidLexicalScope: {
						...
						anyOf: [
							{ $ref: "#/definitions/UseQwikValidLexicalScopeConfiguration" },
							{ type: "null" },
						],
					},
					useSortedClasses: {
					...
					useVueMultiWordComponentNames: {
						...
						anyOf: [
							{
								$ref: "#/definitions/UseVueMultiWordComponentNamesConfiguration",
							},
							{ type: "null" },
						],
					},
			...
			OrganizeImportsOptions: {
				...
				properties: {
					groups: {
						anyOf: [{ $ref: "#/definitions/ImportGroups" }, { type: "null" }],
					},
					identifierOrder: {
						anyOf: [{ $ref: "#/definitions/SortOrder" }, { type: "null" }],
					},
				},
				additionalProperties: false,
			},
			...
			PropertyAssignmentMode: {
				...
				oneOf: [
					{
						description:
							"Allows property assignments on function parameters. This is the default behavior, enabling flexibility in parameter usage.",
						type: "string",
						enum: ["allow"],
					},
					{
						description:
							"Disallows property assignments on function parameters. Enforces stricter immutability to prevent unintended side effects.",
						type: "string",
						enum: ["deny"],
					},
				],
			...
			RuleWithNoAriaUnsupportedElementsOptions: {
				...
				properties: {
					...
					options: {
						description: "Rule's options",
						allOf: [{ $ref: "#/definitions/NoAriaUnsupportedElementsOptions" }],
					},
				},
				additionalProperties: false,
			},
			...
			RuleWithNoConstantMathMinMaxClampOptions: {
				...
				properties: {
					...
					options: {
						description: "Rule's options",
						allOf: [{ $ref: "#/definitions/NoConstantMathMinMaxClampOptions" }],
					},
				},
				additionalProperties: false,
			},
			...
			RuleWithNoDangerouslySetInnerHtmlOptions: {
				...
				properties: {
					...
					options: {
						description: "Rule's options",
						allOf: [{ $ref: "#/definitions/NoDangerouslySetInnerHtmlOptions" }],
					},
				},
				additionalProperties: false,
			},
			...
			RuleWithNoEmptySourceOptions: {
				...
				properties: {
					...
					options: {
						description: "Rule's options",
						allOf: [{ $ref: "#/definitions/NoEmptySourceOptions" }],
					},
				},
				additionalProperties: false,
			},
			...
			RuleWithNoFallthroughSwitchClauseOptions: {
				...
				properties: {
					...
					options: {
						description: "Rule's options",
						allOf: [{ $ref: "#/definitions/NoFallthroughSwitchClauseOptions" }],
					},
				},
				additionalProperties: false,
			},
			...
			RuleWithNoIncrementDecrementOptions: {
				...
				properties: {
					...
					options: {
						description: "Rule's options",
						allOf: [{ $ref: "#/definitions/NoIncrementDecrementOptions" }],
					},
				},
				additionalProperties: false,
			},
			...
			RuleWithNoInvalidConstructorSuperOptions: {
				...
				properties: {
					...
					options: {
						description: "Rule's options",
						allOf: [{ $ref: "#/definitions/NoInvalidConstructorSuperOptions" }],
					},
				},
				additionalProperties: false,
			},
			...
			RuleWithNoJsxLiteralsOptions: {
				...
				properties: {
					...
					options: {
						description: "Rule's options",
						allOf: [{ $ref: "#/definitions/NoJsxLiteralsOptions" }],
					},
				},
				additionalProperties: false,
			},
			...
			RuleWithNoParametersOnlyUsedInRecursionOptions: {
				...
				properties: {
					...
					options: {
						description: "Rule's options",
						allOf: [
							{ $ref: "#/definitions/NoParametersOnlyUsedInRecursionOptions" },
						],
					},
				},
				additionalProperties: false,
			...
			RuleWithNoUnknownAttributeOptions: {
				...
				properties: {
					...
					options: {
						description: "Rule's options",
						allOf: [{ $ref: "#/definitions/NoUnknownAttributeOptions" }],
					},
				},
				additionalProperties: false,
			},
			...
			RuleWithNoUnknownMediaFeatureNameOptions: {
				...
				properties: {
					...
					options: {
						description: "Rule's options",
						allOf: [{ $ref: "#/definitions/NoUnknownMediaFeatureNameOptions" }],
					},
				},
				additionalProperties: false,
			},
			...
			RuleWithNoUnusedExpressionsOptions: {
				...
				properties: {
					...
					options: {
						description: "Rule's options",
						allOf: [{ $ref: "#/definitions/NoUnusedExpressionsOptions" }],
					},
				},
				additionalProperties: false,
			},
			...
			RuleWithNoVueDuplicateKeysOptions: {
				...
				properties: {
					...
					options: {
						description: "Rule's options",
						allOf: [{ $ref: "#/definitions/NoVueDuplicateKeysOptions" }],
					},
				},
				additionalProperties: false,
			},
			...
			RuleWithUseArraySortCompareOptions: {
				...
				properties: {
					...
					options: {
						description: "Rule's options",
						allOf: [{ $ref: "#/definitions/UseArraySortCompareOptions" }],
					},
				},
				additionalProperties: false,
			},
			...
			RuleWithUseDeprecatedDateOptions: {
				...
				properties: {
					...
					options: {
						description: "Rule's options",
						allOf: [{ $ref: "#/definitions/UseDeprecatedDateOptions" }],
					},
				},
				additionalProperties: false,
			},
			...
			RuleWithUseExponentiationOperatorOptions: {
				...
				properties: {
					...
					options: {
						description: "Rule's options",
						allOf: [{ $ref: "#/definitions/UseExponentiationOperatorOptions" }],
					},
				},
				additionalProperties: false,
			},
			...
			RuleWithUseGraphqlNamedOperationsOptions: {
				...
				properties: {
					...
					options: {
						description: "Rule's options",
						allOf: [{ $ref: "#/definitions/UseGraphqlNamedOperationsOptions" }],
					},
				},
				additionalProperties: false,
			},
			...
			RuleWithUseIterableCallbackReturnOptions: {
				...
				properties: {
					...
					options: {
						description: "Rule's options",
						allOf: [{ $ref: "#/definitions/UseIterableCallbackReturnOptions" }],
					},
				},
				additionalProperties: false,
			},
			...
			RuleWithUseQwikMethodUsageOptions: {
				...
				properties: {
					...
					options: {
						description: "Rule's options",
						allOf: [{ $ref: "#/definitions/UseQwikMethodUsageOptions" }],
					},
				},
				additionalProperties: false,
			},
			RuleWithUseQwikValidLexicalScopeOptions: {
				...
				properties: {
					...
					options: {
						description: "Rule's options",
						allOf: [{ $ref: "#/definitions/UseQwikValidLexicalScopeOptions" }],
					},
				},
				additionalProperties: false,
			},
			...
			RuleWithUseVueMultiWordComponentNamesOptions: {
				...
				properties: {
					...
					options: {
						description: "Rule's options",
						allOf: [
							{ $ref: "#/definitions/UseVueMultiWordComponentNamesOptions" },
						],
					},
				},
				additionalProperties: false,
			...
			UseArraySortCompareConfiguration: {
				anyOf: [
					{ $ref: "#/definitions/RulePlainConfiguration" },
					{ $ref: "#/definitions/RuleWithUseArraySortCompareOptions" },
				],
			},
			...
			UseConsistentArrayTypeOptions: {
				...
				properties: {
					syntax: {
						anyOf: [
							{ $ref: "#/definitions/ConsistentArrayType" },
							{ type: "null" },
						],
					},
				},
			...
			UseConsistentArrowReturnConfiguration: {
				anyOf: [
					{ $ref: "#/definitions/RulePlainConfiguration" },
					{ $ref: "#/definitions/RuleWithUseConsistentArrowReturnOptions" },
				],
			},
			UseConsistentArrowReturnOptions: {
				...
				properties: {
					...
					style: {
						...
						anyOf: [
							{ $ref: "#/definitions/UseConsistentArrowReturnStyle" },
							{ type: "null" },
						],
					},
				},
			...
			UseConsistentMemberAccessibilityOptions: {
				...
				properties: {
					accessibility: {
						...
						anyOf: [{ $ref: "#/definitions/Accessibility" }, { type: "null" }],
					},
				},
				additionalProperties: false,
			},
			...
			UseConsistentObjectDefinitionsOptions: {
				...
				properties: {
					syntax: {
						...
						anyOf: [
							{ $ref: "#/definitions/ObjectPropertySyntax" },
							{ type: "null" },
						],
					},
				},
			...
			UseConsistentTypeDefinitionsOptions: {
				...
				properties: {
					style: {
						anyOf: [
							{ $ref: "#/definitions/ConsistentTypeDefinition" },
							{ type: "null" },
						],
					},
				},
			...
			UseDeprecatedDateConfiguration: {
				anyOf: [
					{ $ref: "#/definitions/RulePlainConfiguration" },
					{ $ref: "#/definitions/RuleWithUseDeprecatedDateOptions" },
				],
			},
			...
			UseFilenamingConventionOptions: {
				...
				properties: {
					filenameCases: {
						...
						anyOf: [{ $ref: "#/definitions/FilenameCases" }, { type: "null" }],
					},
					match: {
						description: "Regular expression to enforce",
						anyOf: [{ $ref: "#/definitions/Regex" }, { type: "null" }],
			...
			UseImportTypeOptions: {
				...
				properties: {
					style: {
						...
						anyOf: [{ $ref: "#/definitions/Style2" }, { type: "null" }],
					},
				},
				additionalProperties: false,
			},
			...
			UseQwikMethodUsageConfiguration: {
				anyOf: [
					{ $ref: "#/definitions/RulePlainConfiguration" },
					{ $ref: "#/definitions/RuleWithUseQwikMethodUsageOptions" },
				],
			},
			...
			UseQwikValidLexicalScopeConfiguration: {
				anyOf: [
					{ $ref: "#/definitions/RulePlainConfiguration" },
					{ $ref: "#/definitions/RuleWithUseQwikValidLexicalScopeOptions" },
				],
			},
			...
			UseVueMultiWordComponentNamesConfiguration: {
				anyOf: [
					{ $ref: "#/definitions/RulePlainConfiguration" },
					{
						$ref: "#/definitions/RuleWithUseVueMultiWordComponentNamesOptions",
					},
				],
			},
