	...
	const schema = {
		...
		properties: {
			...
			formatter: {
				...
				anyOf: [{ $ref: "#/$defs/FormatterConfiguration" }, { type: "null" }],
			},
			graphql: {
		...
		$defs: {
			...
			HtmlFormatterConfiguration: {
				...
				properties: {
					...
					indentScriptAndStyle: {
						...
						anyOf: [{ $ref: "#/$defs/IndentScriptAndStyle" }, { type: "null" }],
					},
					indentStyle: {
						description:
			...
			JsonFormatterConfiguration: {
				...
				properties: {
					...
					trailingCommas: {
						description:
							"Prints trailing commas wherever possible in multiline comma-separated structures. Defaults\nto `none`.",
						anyOf: [{ $ref: "#/$defs/JsonTrailingCommas" }, { type: "null" }],
					},
					trailingNewline: {
						description:
							"Whether to add a trailing newline at the end of the file. If unset, inherits the global\ntrailing newline setting.",
			...
			NoBunModulesConfiguration: {
				oneOf: [
					{ $ref: "#/$defs/RulePlainConfiguration" },
					{ $ref: "#/$defs/RuleWithNoBunModulesOptions" },
				],
			},
			NoBunModulesOptions: { type: "object", additionalProperties: false },
			...
			NoInvalidFileInputAcceptConfiguration: {
				oneOf: [
					{ $ref: "#/$defs/RulePlainConfiguration" },
					{ $ref: "#/$defs/RuleWithNoInvalidFileInputAcceptOptions" },
				],
			},
			NoInvalidFileInputAcceptOptions: {
				type: "object",
				additionalProperties: false,
			},
			...
			NoJsonUnsafeValuesConfiguration: {
				oneOf: [
					{ $ref: "#/$defs/RulePlainConfiguration" },
					{ $ref: "#/$defs/RuleWithNoJsonUnsafeValuesOptions" },
				],
			},
			NoJsonUnsafeValuesOptions: {
				type: "object",
				additionalProperties: false,
			},
			...
			NoObsoleteTagsConfiguration: {
				oneOf: [
					{ $ref: "#/$defs/RulePlainConfiguration" },
					{ $ref: "#/$defs/RuleWithNoObsoleteTagsOptions" },
				],
			},
			NoObsoleteTagsOptions: {
				type: "object",
				additionalProperties: false,
			},
			...
			NoReturnInFinallyConfiguration: {
				oneOf: [
					{ $ref: "#/$defs/RulePlainConfiguration" },
					{ $ref: "#/$defs/RuleWithNoReturnInFinallyOptions" },
				],
			},
			NoReturnInFinallyOptions: {
				type: "object",
				additionalProperties: false,
			},
			...
			NoSvelteAtDebugTagsConfiguration: {
				oneOf: [
					{ $ref: "#/$defs/RulePlainConfiguration" },
					{ $ref: "#/$defs/RuleWithNoSvelteAtDebugTagsOptions" },
				],
			},
			NoSvelteAtDebugTagsOptions: {
				type: "object",
				additionalProperties: false,
			},
			NoSvelteAtHtmlTagsConfiguration: {
				oneOf: [
					{ $ref: "#/$defs/RulePlainConfiguration" },
					{ $ref: "#/$defs/RuleWithNoSvelteAtHtmlTagsOptions" },
				],
			},
			NoSvelteAtHtmlTagsOptions: {
				type: "object",
				additionalProperties: false,
			},
			...
			NoThisOutsideOfClassConfiguration: {
				oneOf: [
					{ $ref: "#/$defs/RulePlainConfiguration" },
					{ $ref: "#/$defs/RuleWithNoThisOutsideOfClassOptions" },
				],
			},
			NoThisOutsideOfClassOptions: {
				type: "object",
				additionalProperties: false,
			},
			...
			NoUnmodifiedLoopConditionConfiguration: {
				oneOf: [
					{ $ref: "#/$defs/RulePlainConfiguration" },
					{ $ref: "#/$defs/RuleWithNoUnmodifiedLoopConditionOptions" },
				],
			},
			NoUnmodifiedLoopConditionOptions: {
				type: "object",
				additionalProperties: false,
			},
			...
			NoUnsafeIframeSandboxConfiguration: {
				oneOf: [
					{ $ref: "#/$defs/RulePlainConfiguration" },
					{ $ref: "#/$defs/RuleWithNoUnsafeIframeSandboxOptions" },
				],
			},
			NoUnsafeIframeSandboxOptions: {
				type: "object",
				additionalProperties: false,
			},
			...
			NoVueDeprecatedScopedSlotsConfiguration: {
				oneOf: [
					{ $ref: "#/$defs/RulePlainConfiguration" },
					{ $ref: "#/$defs/RuleWithNoVueDeprecatedScopedSlotsOptions" },
				],
			},
			NoVueDeprecatedScopedSlotsOptions: {
				type: "object",
				additionalProperties: false,
			},
			...
			NoVueUndeclaredDirectivesConfiguration: {
				oneOf: [
					{ $ref: "#/$defs/RulePlainConfiguration" },
					{ $ref: "#/$defs/RuleWithNoVueUndeclaredDirectivesOptions" },
				],
			},
			...
			NoXorAsExponentiationConfiguration: {
				oneOf: [
					{ $ref: "#/$defs/RulePlainConfiguration" },
					{ $ref: "#/$defs/RuleWithNoXorAsExponentiationOptions" },
				],
			},
			NoXorAsExponentiationOptions: {
				type: "object",
				additionalProperties: false,
			},
			...
			Nursery: {
				...
				properties: {
					...
					noBunModules: {
						...
						anyOf: [
							{ $ref: "#/$defs/NoBunModulesConfiguration" },
							{ type: "null" },
						],
					},
					...
					noInvalidFileInputAccept: {
						...
						anyOf: [
							{ $ref: "#/$defs/NoInvalidFileInputAcceptConfiguration" },
							{ type: "null" },
						],
					},
					...
					noJsonUnsafeValues: {
						...
						anyOf: [
							{ $ref: "#/$defs/NoJsonUnsafeValuesConfiguration" },
							{ type: "null" },
						],
					},
					noJsxLeakedDollar: {
					...
					noObsoleteTags: {
						...
						anyOf: [
							{ $ref: "#/$defs/NoObsoleteTagsConfiguration" },
							{ type: "null" },
						],
					},
					...
					noReturnInFinally: {
						...
						anyOf: [
							{ $ref: "#/$defs/NoReturnInFinallyConfiguration" },
							{ type: "null" },
						],
					},
					noSvelteAtDebugTags: {
						...
						anyOf: [
							{ $ref: "#/$defs/NoSvelteAtDebugTagsConfiguration" },
							{ type: "null" },
						],
					},
					noSvelteAtHtmlTags: {
						...
						anyOf: [
							{ $ref: "#/$defs/NoSvelteAtHtmlTagsConfiguration" },
							{ type: "null" },
						],
					},
					noSvelteLegacyConst: {
					...
					noThisOutsideOfClass: {
						...
						anyOf: [
							{ $ref: "#/$defs/NoThisOutsideOfClassConfiguration" },
							{ type: "null" },
						],
					},
					noTopLevelLiterals: {
					...
					noUnmodifiedLoopCondition: {
						...
						anyOf: [
							{ $ref: "#/$defs/NoUnmodifiedLoopConditionConfiguration" },
							{ type: "null" },
						],
					},
					...
					noUnsafeIframeSandbox: {
						...
						anyOf: [
							{ $ref: "#/$defs/NoUnsafeIframeSandboxConfiguration" },
							{ type: "null" },
						],
					},
					...
					noVueDeprecatedScopedSlots: {
						...
						anyOf: [
							{ $ref: "#/$defs/NoVueDeprecatedScopedSlotsConfiguration" },
							{ type: "null" },
						],
					},
					...
					noVueUndeclaredDirectives: {
						...
						anyOf: [
							{ $ref: "#/$defs/NoVueUndeclaredDirectivesConfiguration" },
							{ type: "null" },
						],
					},
					...
					noXorAsExponentiation: {
						...
						anyOf: [
							{ $ref: "#/$defs/NoXorAsExponentiationConfiguration" },
							{ type: "null" },
						],
					},
					preset: {
					...
					useBetterDomTraversing: {
						...
						anyOf: [
							{ $ref: "#/$defs/UseBetterDomTraversingConfiguration" },
							{ type: "null" },
						],
					},
					useConsistentFunctionStyle: {
						...
						anyOf: [
							{ $ref: "#/$defs/UseConsistentFunctionStyleConfiguration" },
							{ type: "null" },
						],
					},
					useConsistentObjectKeys: {
						...
						anyOf: [
							{ $ref: "#/$defs/UseConsistentObjectKeysConfiguration" },
							{ type: "null" },
						],
					},
					useConsistentTestIt: {
					...
					useFlatMathMinMax: {
						...
						anyOf: [
							{ $ref: "#/$defs/UseFlatMathMinMaxConfiguration" },
							{ type: "null" },
						],
					},
					useIframeSandbox: {
					...
					useLayeredStyles: {
						...
						anyOf: [
							{ $ref: "#/$defs/UseLayeredStylesConfiguration" },
							{ type: "null" },
						],
					},
					useMathMinMax: {
					...
					useModernMathApis: {
						...
						anyOf: [
							{ $ref: "#/$defs/UseModernMathApisConfiguration" },
							{ type: "null" },
						],
					},
					...
					useReactNamingConvention: {
						...
						anyOf: [
							{ $ref: "#/$defs/UseReactNamingConventionConfiguration" },
							{ type: "null" },
						],
					},
					...
					useValidTestTitle: {
						...
						anyOf: [
							{ $ref: "#/$defs/UseValidTestTitleConfiguration" },
							{ type: "null" },
						],
					},
					useVarsOnTop: {
			...
			RuleWithNoBunModulesOptions: {
				...
				properties: {
					level: { $ref: "#/$defs/RulePlainConfiguration" },
					options: { $ref: "#/$defs/NoBunModulesOptions" },
				},
				additionalProperties: false,
				required: ["level"],
			},
			...
			RuleWithNoInvalidFileInputAcceptOptions: {
				...
				properties: {
					fix: { anyOf: [{ $ref: "#/$defs/FixKind" }, { type: "null" }] },
					level: { $ref: "#/$defs/RulePlainConfiguration" },
					options: { $ref: "#/$defs/NoInvalidFileInputAcceptOptions" },
				},
				additionalProperties: false,
				required: ["level"],
			},
			...
			RuleWithNoJsonUnsafeValuesOptions: {
				...
				properties: {
					level: { $ref: "#/$defs/RulePlainConfiguration" },
					options: { $ref: "#/$defs/NoJsonUnsafeValuesOptions" },
				},
				additionalProperties: false,
				required: ["level"],
			},
			...
			RuleWithNoObsoleteTagsOptions: {
				...
				properties: {
					level: { $ref: "#/$defs/RulePlainConfiguration" },
					options: { $ref: "#/$defs/NoObsoleteTagsOptions" },
				},
				additionalProperties: false,
				required: ["level"],
			},
			...
			RuleWithNoReturnInFinallyOptions: {
				...
				properties: {
					level: { $ref: "#/$defs/RulePlainConfiguration" },
					options: { $ref: "#/$defs/NoReturnInFinallyOptions" },
				},
				additionalProperties: false,
				required: ["level"],
			},
			...
			RuleWithNoSvelteAtDebugTagsOptions: {
				...
				properties: {
					fix: { anyOf: [{ $ref: "#/$defs/FixKind" }, { type: "null" }] },
					level: { $ref: "#/$defs/RulePlainConfiguration" },
					options: { $ref: "#/$defs/NoSvelteAtDebugTagsOptions" },
				},
				additionalProperties: false,
				required: ["level"],
			},
			RuleWithNoSvelteAtHtmlTagsOptions: {
				...
				properties: {
					level: { $ref: "#/$defs/RulePlainConfiguration" },
					options: { $ref: "#/$defs/NoSvelteAtHtmlTagsOptions" },
				},
				additionalProperties: false,
				required: ["level"],
			},
			...
			RuleWithNoThisOutsideOfClassOptions: {
				...
				properties: {
					level: { $ref: "#/$defs/RulePlainConfiguration" },
					options: { $ref: "#/$defs/NoThisOutsideOfClassOptions" },
				},
				additionalProperties: false,
				required: ["level"],
			},
			...
			RuleWithNoUnmodifiedLoopConditionOptions: {
				...
				properties: {
					level: { $ref: "#/$defs/RulePlainConfiguration" },
					options: { $ref: "#/$defs/NoUnmodifiedLoopConditionOptions" },
				},
				additionalProperties: false,
				required: ["level"],
			},
			...
			RuleWithNoUnsafeIframeSandboxOptions: {
				...
				properties: {
					level: { $ref: "#/$defs/RulePlainConfiguration" },
					options: { $ref: "#/$defs/NoUnsafeIframeSandboxOptions" },
				},
				additionalProperties: false,
				required: ["level"],
			},
			...
			RuleWithNoVueDeprecatedScopedSlotsOptions: {
				...
				properties: {
					fix: { anyOf: [{ $ref: "#/$defs/FixKind" }, { type: "null" }] },
					level: { $ref: "#/$defs/RulePlainConfiguration" },
					options: { $ref: "#/$defs/NoVueDeprecatedScopedSlotsOptions" },
				},
				additionalProperties: false,
				required: ["level"],
			},
			...
			RuleWithNoVueUndeclaredDirectivesOptions: {
				...
				properties: {
					level: { $ref: "#/$defs/RulePlainConfiguration" },
					options: { $ref: "#/$defs/NoVueUndeclaredDirectivesOptions" },
				},
				additionalProperties: false,
				required: ["level"],
			},
			...
			RuleWithNoXorAsExponentiationOptions: {
				...
				properties: {
					fix: { anyOf: [{ $ref: "#/$defs/FixKind" }, { type: "null" }] },
					level: { $ref: "#/$defs/RulePlainConfiguration" },
					options: { $ref: "#/$defs/NoXorAsExponentiationOptions" },
				},
				additionalProperties: false,
				required: ["level"],
			},
			...
			RuleWithUseBetterDomTraversingOptions: {
				...
				properties: {
					fix: { anyOf: [{ $ref: "#/$defs/FixKind" }, { type: "null" }] },
					level: { $ref: "#/$defs/RulePlainConfiguration" },
					options: { $ref: "#/$defs/UseBetterDomTraversingOptions" },
				},
				additionalProperties: false,
				required: ["level"],
			},
			...
			RuleWithUseConsistentFunctionStyleOptions: {
				...
				properties: {
					level: { $ref: "#/$defs/RulePlainConfiguration" },
					options: { $ref: "#/$defs/UseConsistentFunctionStyleOptions" },
				},
				additionalProperties: false,
				required: ["level"],
			},
			...
			RuleWithUseConsistentObjectKeysOptions: {
				...
				properties: {
					fix: { anyOf: [{ $ref: "#/$defs/FixKind" }, { type: "null" }] },
					level: { $ref: "#/$defs/RulePlainConfiguration" },
					options: { $ref: "#/$defs/UseConsistentObjectKeysOptions" },
				},
				additionalProperties: false,
				required: ["level"],
			},
			...
			RuleWithUseFlatMathMinMaxOptions: {
				...
				properties: {
					fix: { anyOf: [{ $ref: "#/$defs/FixKind" }, { type: "null" }] },
					level: { $ref: "#/$defs/RulePlainConfiguration" },
					options: { $ref: "#/$defs/UseFlatMathMinMaxOptions" },
				},
				additionalProperties: false,
				required: ["level"],
			},
			...
			RuleWithUseLayeredStylesOptions: {
				...
				properties: {
					level: { $ref: "#/$defs/RulePlainConfiguration" },
					options: { $ref: "#/$defs/UseLayeredStylesOptions" },
				},
				additionalProperties: false,
				required: ["level"],
			},
			...
			RuleWithUseModernMathApisOptions: {
				...
				properties: {
					fix: { anyOf: [{ $ref: "#/$defs/FixKind" }, { type: "null" }] },
					level: { $ref: "#/$defs/RulePlainConfiguration" },
					options: { $ref: "#/$defs/UseModernMathApisOptions" },
				},
				additionalProperties: false,
				required: ["level"],
			},
			...
			RuleWithUseReactNamingConventionOptions: {
				...
				properties: {
					level: { $ref: "#/$defs/RulePlainConfiguration" },
					options: { $ref: "#/$defs/UseReactNamingConventionOptions" },
				},
				additionalProperties: false,
				required: ["level"],
			},
			...
			RuleWithUseValidTestTitleOptions: {
				...
				properties: {
					fix: { anyOf: [{ $ref: "#/$defs/FixKind" }, { type: "null" }] },
					level: { $ref: "#/$defs/RulePlainConfiguration" },
					options: { $ref: "#/$defs/UseValidTestTitleOptions" },
				},
				additionalProperties: false,
				required: ["level"],
			},
			...
			Rules: {
				...
				properties: {
					...
					complexity: {
						anyOf: [{ $ref: "#/$defs/SeverityOrComplexity" }, { type: "null" }],
					},
					correctness: {
						anyOf: [
					...
					security: {
						anyOf: [{ $ref: "#/$defs/SeverityOrSecurity" }, { type: "null" }],
					},
					style: {
						anyOf: [{ $ref: "#/$defs/SeverityOrStyle" }, { type: "null" }],
					},
					suspicious: {
						anyOf: [{ $ref: "#/$defs/SeverityOrSuspicious" }, { type: "null" }],
					},
				},
				additionalProperties: false,
			},
			...
			StableHookResult: {
				oneOf: [
					...
					{
						description:
							"Used to indicate the hook returns an object and some of its properties have stable identities.",
						type: "array",
						items: { type: "string" },
						minItems: 1,
					},
			...
			UseBetterDomTraversingConfiguration: {
				oneOf: [
					{ $ref: "#/$defs/RulePlainConfiguration" },
					{ $ref: "#/$defs/RuleWithUseBetterDomTraversingOptions" },
				],
			},
			UseBetterDomTraversingOptions: {
				type: "object",
				additionalProperties: false,
			},
			...
			UseConsistentArrayTypeOptions: {
				...
				properties: {
					syntax: {
						anyOf: [{ $ref: "#/$defs/ConsistentArrayType" }, { type: "null" }],
					},
				},
				additionalProperties: false,
			},
			...
			UseConsistentFunctionStyleConfiguration: {
				oneOf: [
					{ $ref: "#/$defs/RulePlainConfiguration" },
					{ $ref: "#/$defs/RuleWithUseConsistentFunctionStyleOptions" },
				],
			},
			UseConsistentFunctionStyleOptions: {
				...
				properties: {
					...
					style: {
						...
						anyOf: [{ $ref: "#/$defs/FunctionStyle" }, { type: "null" }],
					},
				},
				additionalProperties: false,
			},
			...
			UseConsistentObjectDefinitionsOptions: {
				...
				properties: {
					syntax: {
						...
						anyOf: [{ $ref: "#/$defs/ObjectPropertySyntax" }, { type: "null" }],
					},
				},
				additionalProperties: false,
			},
			UseConsistentObjectKeysConfiguration: {
				oneOf: [
					{ $ref: "#/$defs/RulePlainConfiguration" },
					{ $ref: "#/$defs/RuleWithUseConsistentObjectKeysOptions" },
				],
			},
			UseConsistentObjectKeysOptions: {
				type: "object",
				properties: {
					form: {
						description:
						...
						anyOf: [{ $ref: "#/$defs/NormalizationForm" }, { type: "null" }],
					},
				},
				additionalProperties: false,
			},
			...
			UseExportTypeOptions: {
				...
				properties: {
					style: {
						...
						anyOf: [{ $ref: "#/$defs/UseExportTypeStyle" }, { type: "null" }],
					},
				},
				additionalProperties: false,
			},
			...
			UseFlatMathMinMaxConfiguration: {
				oneOf: [
					{ $ref: "#/$defs/RulePlainConfiguration" },
					{ $ref: "#/$defs/RuleWithUseFlatMathMinMaxOptions" },
				],
			},
			UseFlatMathMinMaxOptions: {
				type: "object",
				additionalProperties: false,
			},
			...
			UseImportTypeOptions: {
				...
				properties: {
					style: {
						...
						anyOf: [{ $ref: "#/$defs/UseImportTypeStyle" }, { type: "null" }],
					},
				},
				additionalProperties: false,
			},
			...
			UseLayeredStylesConfiguration: {
				oneOf: [
					{ $ref: "#/$defs/RulePlainConfiguration" },
					{ $ref: "#/$defs/RuleWithUseLayeredStylesOptions" },
				],
			},
			UseLayeredStylesOptions: {
				type: "object",
				properties: {
					requireImportLayers: {
						description:
			...
			UseModernMathApisConfiguration: {
				oneOf: [
					{ $ref: "#/$defs/RulePlainConfiguration" },
					{ $ref: "#/$defs/RuleWithUseModernMathApisOptions" },
				],
			},
			UseModernMathApisOptions: {
				type: "object",
				additionalProperties: false,
			},
			...
			UseReactNamingConventionConfiguration: {
				oneOf: [
					{ $ref: "#/$defs/RulePlainConfiguration" },
					{ $ref: "#/$defs/RuleWithUseReactNamingConventionOptions" },
				],
			},
			UseReactNamingConventionOptions: {
				type: "object",
				additionalProperties: false,
			},
			...
			UseValidTestTitleConfiguration: {
				oneOf: [
					{ $ref: "#/$defs/RulePlainConfiguration" },
					{ $ref: "#/$defs/RuleWithUseValidTestTitleOptions" },
				],
			},
			UseValidTestTitleOptions: {
				type: "object",
				properties: {
					disallowedWords: {
						description: "A list of words that are disallowed in test titles.",
						type: ["array", "null"],
						items: { type: "string" },
					},
				},
			...
			UseVueConsistentVOnStyleOptions: {
				...
				properties: {
					style: {
						...
						anyOf: [{ $ref: "#/$defs/VueDirectiveStyle2" }, { type: "null" }],
					},
				},
				additionalProperties: false,
			},
