...
<div class="hero-code">
    ...
    Biome 是一个适用于 _JavaScript_、_TypeScript_、_JSX_、_JSON_、_CSS_ 和 _GraphQL_ 的[**快速格式化工具**](https://github.com/biomejs/biome/tree/main/benchmark#formatting)，[**与 _Prettier_ 有高达 97% 的兼容覆盖率**](https://console.algora.io/challenges/prettier)，能有效**节约持续化集成和开发者的时间**。

    Biome 甚至允许你在使用[你最爱的编辑器](/zh-cn/guides/editors/first-party-extensions/)编写代码时，格式化中间形态的**格式错误的代码**。
...
<div class="hero-code">
    ...
    Biome 是一个适用于 _JavaScript_、_TypeScript_、_JSX_、_CSS_ 和 _GraphQL_ 的[**高性能 linter**](https://github.com/biomejs/biome/tree/main/benchmark#linting)，拥有来自 ESLint、typescript-eslint 以及[其它规则源](https://github.com/biomejs/biome/discussions/3)的[超过 200 条规则](/linter/rules/)。
...
<div class="installation-body">
  <div class="installation">
    <div class="installation-left">
      ...
      <a class="installation-biome" href="/zh-cn/guides/getting-started/">
        使用包管理器安装
        <Image src={arrow} alt="arrow" />
      </a>
      <a
        href="/zh-cn/guides/editors/first-party-extensions/"
