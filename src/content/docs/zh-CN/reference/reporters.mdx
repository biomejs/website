...
使用此 reporter 来发出遵循 [Checkstyle 格式](https://checkstyle.org/)的诊断信息。
...
使用此 reporter 来发出遵循 [RDJSON 格式](https://deepwiki.com/reviewdog/reviewdog/3.2-reviewdog-diagnostic-format)的诊断信息。
...
使用此 reporter 来发出遵循 [SARIF 格式](https://sarifweb.azurewebsites.net/)的诊断信息。
