...
2. 你是否开启了[项目规则](/zh-CN/linter/domains/#project)？该功能会带来额外性能开销，但能提供更深度的代码分析。你也可以查看对应答疑文档[为什么新版 Biome 检查器相比 v1 速度变慢](/zh-CN/linter/#why-is-biome-linter-so-slow-compared-to-v1)。尝试关闭该功能，查看运行速度是否提升。
