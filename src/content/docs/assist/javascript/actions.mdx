...
| [useSortedKeys](/assist/actions/use-sorted-keys) | Enforce ordering of a JS object properties. | <span class='inline-icon' title="This rule is only available in beta"><Icon name="moon" label="This rule is only available in beta" size="1.2rem" /></span> |
## Recommended rules 
