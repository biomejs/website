...
| --- | --- | --- |
| [noDuplicateClasses](/assist/actions/no-duplicate-classes) | Remove duplicate CSS classes. | <span class='inline-icon' title='The rule has a safe fix.'><Icon name="seti:config" label="The rule has a safe fix" size="1.2rem"  /></span><span class='inline-icon' title="This rule is not released yet"><Icon name="moon" label="This rule is not released yet" size="1.2rem" /></span> |
...
| [useSortedInterfaceMembers](/assist/actions/use-sorted-interface-members) | Sort interface members by key. | <span class='inline-icon' title='The rule has a safe fix.'><Icon name="seti:config" label="The rule has a safe fix" size="1.2rem"  /></span><span class='inline-icon' title="This rule is not released yet"><Icon name="moon" label="This rule is not released yet" size="1.2rem" /></span> |
