...
| [useSortedAttributes](/assist/actions/use-sorted-attributes) | Enforce attribute sorting in JSX elements. | <span class='inline-icon' title="This rule is not recommended" ><Icon name="information" size="1.2rem" label="This rule is not recommended" /></span><span class='inline-icon' title='The rule has a safe fix.'><Icon name="seti:config" label="The rule has a safe fix" size="1.2rem"  /></span> |
| [useSortedKeys](/assist/actions/use-sorted-keys) | Sort properties of a JS object in natural order. | <span class='inline-icon' title="This rule is not recommended" ><Icon name="information" size="1.2rem" label="This rule is not recommended" /></span><span class='inline-icon' title='The rule has a safe fix.'><Icon name="seti:config" label="The rule has a safe fix" size="1.2rem"  /></span> |
## Recommended actions 
