...
| [useSortedPackageJson](/assist/actions/use-sorted-package-json) | Organize package.json fields according to established conventions. | <span class='inline-icon' title='The rule has a safe fix.'><Icon name="seti:config" label="The rule has a safe fix" size="1.2rem"  /></span> |
## Recommended actions 
