...
| [useSortedPackageJson](/assist/actions/use-sorted-package-json) | Organize package.json fields according to established conventions. | <span class='inline-icon' title='The rule has a safe fix.'><Icon name="seti:config" label="The rule has a safe fix" size="1.2rem"  /></span><span class='inline-icon' title="This rule is not released yet"><Icon name="moon" label="This rule is not released yet" size="1.2rem" /></span> |
## Recommended actions 
