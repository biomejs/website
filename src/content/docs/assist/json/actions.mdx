...
| --- | --- | --- |
| [useSortedKeys](/assist/actions/use-sorted-keys) | Sort the keys of a JSON object in natural order. | <span class='inline-icon' title='The rule has a safe fix.'><Icon name="seti:config" label="The rule has a safe fix" size="1.2rem"  /></span> |
## Recommended actions 
