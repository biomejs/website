---
title: Журнал змін
description: Журнал змін Biome
tableOfContents:
  maxHeadingLevel: 2
---
# Журнал змін Biome

Цей проект дотримується [Семантичного версіонування](https://semver.org/spec/v2.0.0.html).
Через природу Biome як інструментарію,
може бути незрозуміло, які зміни вважаються основними, другорядними або виправленнями.
Прочитайте наші [рекомендації щодо категоризації змін](https://biomejs.dev/internals/versioning).

Нові записи повинні бути розміщені в розділі під назвою `Unreleased`.
Прочитайте наші [рекомендації щодо написання хорошого запису в журнал змін](https://github.com/biomejs/biome/blob/main/CONTRIBUTING.md#changelog).
