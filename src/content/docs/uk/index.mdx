...
template: splash
description: Форматування, лінтинг та більше за частку секунди.
editUrl: false
next: false

hero:
  title: Один інструментарій для вашого веб-проєкту
  tagline: Форматування, лінтинг та більше за частку секунди.
  image:
...
<div class="hero-code">
    <h2 class="head">Форматуйте код як Prettier, економте час</h2>

    **Biome є [швидким форматувальником](https://github.com/biomejs/biome/tree/main/benchmark#formatting)** для _JavaScript_, _TypeScript_, _JSX_, _TSX_, _JSON_, _CSS_ та _GraphQL_, що має **[97% сумісність з _Prettier_](https://console.algora.io/challenges/prettier)**, **економлячи час CI та розробників**.

    Biome може навіть **форматувати некоректний код** під час написання у [вашому улюбленому редакторі](/guides/integrate-in-editor/).
    ...
    Спробуйте форматувальник Biome на [пісочниці](/playground/) або безпосередньо на вашому проєкті:
...
<div class="hero-code">
    ...
    **Biome є [продуктивним лінтером](https://github.com/biomejs/biome/tree/main/benchmark#linting)** для _JavaScript_, _TypeScript_, _JSX_, _CSS_ та _GraphQL_, що має **[<NumberOfRules/> правил](/linter/rules/)** з ESLint, TypeScript ESLint та [інших джерел](/linter/rules-sources/).

    **Biome видає детальні та контекстуалізовані діагностики**, що допомагають покращити ваш код та стати кращим програмістом!

    <LinterExample />

    Спробуйте лінтер Biome на [пісочниці](/playground/) або безпосередньо на вашому проєкті:
...
<CardGrid>
    ...
    <Card title="Масштабований" icon="random">
      Розроблений для роботи з кодовими базами будь-якого розміру. Зосередьтеся на розвитку продукту, а не інструментів.
    </Card>
    <Card title="Оптимізований" icon="setting">
      Завдяки тісній внутрішній інтеграції ми можемо повторно використовувати попередню роботу, і будь-яке покращення одного інструменту покращує всі інші.
    </Card>
    <Card title="Інформативний" icon="information">
    ...
    <Card title="Все включено" icon="add-document">
...
<div class="community">
  ...
  <div class="community-connect">
    <div class="community-description">
      Підтримується нашими учасниками з відкритим вихідним кодом
    </div>
