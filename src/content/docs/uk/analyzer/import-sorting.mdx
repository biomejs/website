...
Ви можете застосувати сортування двома способами: через [CLI](#сортування-імпортів-через-cli) або [розширення VSCode](#сортування-імпортів-через-розширення-vscode).
