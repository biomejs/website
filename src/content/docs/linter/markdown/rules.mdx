...
| --- | --- | --- |
| [useConsistentHeadingLevel](/linter/rules/use-consistent-heading-level) | Enforce that all heading levels are consistent and ordered. |  |
| [useTopLevelHeading](/linter/rules/use-top-level-heading) | Require Markdown documents to start with a top-level heading. |  |
## Recommended rules 
