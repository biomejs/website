...
| --- | --- | --- |
| [useConsistentHeadingLevel](/linter/rules/use-consistent-heading-level) | Enforce that all heading levels are consistent and ordered. | <span class='inline-icon' title="This rule is not released yet"><Icon name="moon" label="This rule is not released yet" size="1.2rem" /></span> |
## Recommended rules 
