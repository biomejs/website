...
### Why is Biome linter so slow compared to v2?
...
Such information **is needed** for some rules as `noFloatingPromises`, `noUnresolvedImports` or `noImportCycles`, which can't function otherwise.
