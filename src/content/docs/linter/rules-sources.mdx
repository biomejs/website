...
:::
### @mysticatea/eslint-plugin / @eslint-community/eslint-plugin-mysticatea
| @mysticatea/eslint-plugin rule name | Biome rule name |
| ---- | ---- |
| [no-this-in-static](https://github.com/eslint-community/eslint-plugin-mysticatea/blob/main/docs/rules/no-this-in-static.md) |[noThisInStatic](/linter/rules/no-this-in-static) (inspired) |
