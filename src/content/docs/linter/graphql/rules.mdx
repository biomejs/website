...
| [noDuplicateEnumValueNames](/linter/rules/no-duplicate-enum-value-names) | Require all enum value names to be unique. | <span class='inline-icon' title="This rule is not released yet"><Icon name="moon" label="This rule is not released yet" size="1.2rem" /></span> |
...
| [noRootType](/linter/rules/no-root-type) | Disallow the usage of specified root types | <span class='inline-icon' title="This rule is not released yet"><Icon name="moon" label="This rule is not released yet" size="1.2rem" /></span> |
...
| [useLoneAnonymousOperation](/linter/rules/use-lone-anonymous-operation) | Disallow anonymous operations when more than one operation specified in document. | <span class='inline-icon' title="This rule is not released yet"><Icon name="moon" label="This rule is not released yet" size="1.2rem" /></span> |
| [useLoneExecutableDefinition](/linter/rules/use-lone-executable-definition) | Require queries, mutations, subscriptions or fragments each to be located in separate files. | <span class='inline-icon' title="This rule is not released yet"><Icon name="moon" label="This rule is not released yet" size="1.2rem" /></span> |
