...
| Rule name | Description | Properties |
| --- | --- | --- |
| [noDuplicateArgumentNames](/linter/rules/no-duplicate-argument-names) | Require all argument names for fields & directives to be unique. |  |
| [noDuplicateEnumValueNames](/linter/rules/no-duplicate-enum-value-names) | Require all enum value names to be unique. |  |
| [noDuplicateFieldDefinitionNames](/linter/rules/no-duplicate-field-definition-names) | Require all fields of a type to be unique. |  |
