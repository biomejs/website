...
| [useUniqueArgumentNames](/linter/rules/use-unique-argument-names) | Require all argument names for fields & directives to be unique. |  |
| [useUniqueEnumValueNames](/linter/rules/use-unique-enum-value-names) | Require all enum value names to be unique. | <span class='inline-icon' title="This rule is not released yet"><Icon name="moon" label="This rule is not released yet" size="1.2rem" /></span> |
