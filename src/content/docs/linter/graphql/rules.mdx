...
| [useInputName](/linter/rules/use-input-name) | Require mutation argument to be always called "input" | <span class='inline-icon' title="This rule is not released yet"><Icon name="moon" label="This rule is not released yet" size="1.2rem" /></span> |
