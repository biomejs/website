...
| [useGraphqlNamingConvention](/linter/rules/use-graphql-naming-convention) | Validates that all enum values are capitalized. | <span class='inline-icon' title="This rule is not recommended" ><Icon name="information" size="1.2rem" label="This rule is not recommended" /></span> |
