---
title: noLabelWithoutControl (since v1.8.0)
---
...
<strong><span style="color: Tomato;">  </span></strong><strong><span style="color: Tomato;">&gt;</span></strong> <strong>1 │ </strong>&lt;label for=&quot;js_id&quot; /&gt;;
...
<strong><span style="color: lightgreen;">  </span></strong><strong><span style="color: lightgreen;">ℹ</span></strong> <span style="color: lightgreen;">Consider adding an accessible text content to the label element.</span>
...
<strong><span style="color: Tomato;">  </span></strong><strong><span style="color: Tomato;">&gt;</span></strong> <strong>1 │ </strong>&lt;label for=&quot;js_id&quot;&gt;&lt;input /&gt;&lt;/label&gt;;
...
<strong><span style="color: Tomato;">  </span></strong><strong><span style="color: Tomato;">&gt;</span></strong> <strong>1 │ </strong>&lt;label htmlFor=&quot;js_id&quot; /&gt;;
...
<strong><span style="color: Tomato;">  </span></strong><strong><span style="color: Tomato;">&gt;</span></strong> <strong>1 │ </strong>&lt;label htmlFor=&quot;js_id&quot;&gt;&lt;input /&gt;&lt;/label&gt;;
...
<strong><span style="color: Tomato;">  </span></strong><strong><span style="color: Tomato;">&gt;</span></strong> <strong>1 │ </strong>&lt;label&gt;A label&lt;/label&gt;;
...
<strong><span style="color: lightgreen;">  </span></strong><strong><span style="color: lightgreen;">ℹ</span></strong> <span style="color: lightgreen;">Consider adding a `for` or `htmlFor` attribute to the label element or moving the input element to inside the label element.</span>
...
<strong><span style="color: Tomato;">  </span></strong><strong><span style="color: Tomato;">&gt;</span></strong> <strong>1 │ </strong>&lt;div&gt;&lt;label /&gt;&lt;input /&gt;&lt;/div&gt;;
