...
<RuleLanguageSelect current="css" languages={[{"id":"css","label":"CSS","href":"/linter/rules/no-empty-source/"},{"id":"graphql","label":"GraphQL","href":"/linter/rules/no-empty-source/graphql/"},{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/no-empty-source/javascript/"}]} />
