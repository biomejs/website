...
<RuleLanguageSelect current="javascript" languages={[{"id":"html","label":"HTML","href":"/linter/rules/use-key-with-click-events/"},{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/use-key-with-click-events/javascript/"}]} />
