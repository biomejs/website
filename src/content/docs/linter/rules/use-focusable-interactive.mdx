...
<RuleLanguageSelect current="html" languages={[{"id":"html","label":"HTML","href":"/linter/rules/use-focusable-interactive/"},{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/use-focusable-interactive/javascript/"}]} />
