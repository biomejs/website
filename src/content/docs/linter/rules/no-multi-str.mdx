...
editUrl: "https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/src/lint/nursery/no_multi_str.rs"

title: noMultiStr
description: Learn more about noMultiStr
---
...
- Diagnostic Category: [`lint/nursery/noMultiStr`](/reference/diagnostics#diagnostic-category)
...
- [Source Code](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/src/lint/nursery/no_multi_str.rs)
- [Test Cases](https://github.com/biomejs/biome/blob/main/crates/biome_js_analyze/tests/specs/nursery/noMultiStr)
