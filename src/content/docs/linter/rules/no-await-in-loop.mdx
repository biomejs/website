...
**Diagnostic Category: `lint/nursery/noAwaitInLoop`**
<Tabs>
...
Sources: 
- Same as: <a href="https://eslint.org/docs/latest/rules/no-await-in-loop" target="_blank"><code>no-await-in-loop</code></a>
