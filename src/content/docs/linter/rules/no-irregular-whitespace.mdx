...
<RuleLanguageSelect current="css" languages={[{"id":"css","label":"CSS","href":"/linter/rules/no-irregular-whitespace/"},{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/no-irregular-whitespace/javascript/"}]} />
