...
<RuleLanguageSelect current="html" languages={[{"id":"html","label":"HTML","href":"/linter/rules/use-iframe-sandbox/"},{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/use-iframe-sandbox/javascript/"}]} />
