...
```file=promise-in-ternary-condition.js
const promise = Promise.resolve('value');
...
```file=promise-while-condition.js
const promise = Promise.resolve('value');
