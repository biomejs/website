...
<RuleLanguageSelect current="javascript" languages={[{"id":"css","label":"CSS","href":"/linter/rules/no-useless-escape-in-string/"},{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/no-useless-escape-in-string/javascript/"}]} />
