...
<RuleLanguageSelect current="javascript" languages={[{"id":"html","label":"HTML","href":"/linter/rules/use-valid-aria-values/"},{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/use-valid-aria-values/javascript/"}]} />
