...
Sources: 
- Same as: <a href="https://github.com/import-js/eslint-plugin-import/blob/main/docs/rules/no-extraneous-dependencies.md" target="_blank"><code>import/no-extraneous-dependencies</code></a>
