...
<RuleLanguageSelect current="html" languages={[{"id":"html","label":"HTML","href":"/linter/rules/no-sync-scripts/"},{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/no-sync-scripts/javascript/"}]} />
