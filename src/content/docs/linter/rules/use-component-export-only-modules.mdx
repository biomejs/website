...
If you use a framework that handles [Hot Mudule Replacement(HMR)](https://remix.run/docs/en/main/discussion/hot-module-replacement) of some specific exports, you can use this option to avoid warning for them.
