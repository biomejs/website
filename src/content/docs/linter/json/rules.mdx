...
| --- | --- | --- |
| [noDuplicateDependencies](/linter/rules/no-duplicate-dependencies) | Disallow any dependency from being specified more than once (e.g. in `dependencies` and `devDependencies`) |  |
