...
| ---- | ---- |
| [jsx-a](https://github.com/BuilderIO/eslint-plugin-qwik/blob/main/docs/rules/jsx-a.md) |[useAnchorHref](/linter/rules/use-anchor-href) |
| [jsx-img](https://github.com/BuilderIO/eslint-plugin-qwik/blob/main/docs/rules/jsx-img.md) |[useImageSize](/linter/rules/use-image-size) |
| [no-use-visible-task](https://github.com/BuilderIO/eslint-plugin-qwik/blob/main/docs/rules/no-use-visible-task.md) |[noQwikUseVisibleTask](/linter/rules/no-qwik-use-visible-task) |
| [prefer-classlist](https://github.com/BuilderIO/eslint-plugin-qwik/blob/main/docs/rules/prefer-classlist.md) |[useQwikClasslist](/linter/rules/use-qwik-classlist) |
| [use-method-usage](https://github.com/BuilderIO/eslint-plugin-qwik/blob/main/docs/rules/use-method-usage.md) |[useQwikMethodUsage](/linter/rules/use-qwik-method-usage) |
| [valid-lexical-scope](https://github.com/BuilderIO/eslint-plugin-qwik/blob/main/docs/rules/valid-lexical-scope.md) |[useQwikValidLexicalScope](/linter/rules/use-qwik-valid-lexical-scope) |
### eslint-plugin-react
