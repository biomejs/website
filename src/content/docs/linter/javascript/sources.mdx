...
- [useConsistentResponse](/linter/rules/use-consistent-response) 
...
| [grouped-accessor-pairs](https://eslint.org/docs/latest/rules/grouped-accessor-pairs) |[useAdjacentGetterSetter](/linter/rules/use-adjacent-getter-setter) |
...
| [no-await-in-loop](https://eslint.org/docs/latest/rules/no-await-in-loop) |[noAwaitInLoop](/linter/rules/no-await-in-loop) |
...
| [no-constant-binary-expression](https://eslint.org/docs/latest/rules/no-constant-binary-expression) |[noConstantBinaryExpression](/linter/rules/no-constant-binary-expression) |
...
| [no-implicit-coercion](https://eslint.org/docs/latest/rules/no-implicit-coercion) |[noImplicitCoercion](/linter/rules/no-implicit-coercion) |
...
| [no-useless-backreference](https://eslint.org/docs/latest/rules/no-useless-backreference) |[noUselessBackrefInRegex](/linter/rules/no-useless-backref-in-regex) |
...
| [object-shorthand](https://eslint.org/docs/latest/rules/object-shorthand) |[useConsistentObjectDefinition](/linter/rules/use-consistent-object-definition) (inspired) |
...
| ---- | ---- |
| [no-useless-backreference](https://ota-meshi.github.io/eslint-plugin-regexp/rules/no-useless-backreference.html) |[noUselessBackrefInRegex](/linter/rules/no-useless-backref-in-regex) |
### eslint-plugin-solid
| eslint-plugin-solid Rules name | Biome Rules name |
| ---- | ---- |
| [no-destructure](https://github.com/solidjs-community/eslint-plugin-solid/blob/main/packages/eslint-plugin-solid/docs/no-destructure.md) |[noDestructuredProps](/linter/rules/no-destructured-props) (inspired) |
...
| [prefer-for](https://github.com/solidjs-community/eslint-plugin-solid/blob/main/packages/eslint-plugin-solid/docs/prefer-for.md) |[useForComponent](/linter/rules/use-for-component) (inspired) |
...
| [unified-signatures](https://typescript-eslint.io/rules/unified-signatures) |[useUnifiedTypeSignature](/linter/rules/use-unified-type-signature) |
