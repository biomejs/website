...
| ---- | ---- |
| [no-nested-components](https://eslint-react.xyz/docs/rules/no-nested-components) |[noNestedComponentDefinitions](/linter/rules/no-nested-component-definitions) (inspired) |
...
| [no-done-callback](https://github.com/vitest-dev/eslint-plugin-vitest/blob/main/docs/rule/no-done-callback.md) |[noDoneCallback](/linter/rules/no-done-callback) (inspired) |
...
| [no-regex-spaces](https://eslint.org/docs/latest/rules/no-regex-spaces) |[noAdjacentSpacesInRegex](/linter/rules/no-adjacent-spaces-in-regex) (inspired) |
...
| ---- | ---- |
| [no-process-global](https://lint.deno.land/rules/no-process-global) |[noProcessGlobal](/linter/rules/no-process-global) (inspired) |
...
| ---- | ---- |
| [eslint-plugin-import-access](https://github.com/uhyo/eslint-plugin-import-access) |[noPrivateImports](/linter/rules/no-private-imports) (inspired) |
### eslint-plugin-jest
...
| ---- | ---- |
| [no-multi-asterisks](https://github.com/gajus/eslint-plugin-jsdoc/blob/main/docs/rules/no-multi-asterisks.md) |[useSingleJsDocAsterisk](/linter/rules/use-single-js-doc-asterisk) (inspired) |
...
| [react-compiler](https://github.com/facebook/react/blob/main/packages/eslint-plugin-react-hooks/README.md) |[noReactPropAssign](/linter/rules/no-react-prop-assign) (inspired) |
...
| ---- | ---- |
| [no-useless-backreference](https://ota-meshi.github.io/eslint-plugin-regexp/rules/no-useless-backreference.html) |[noUselessBackrefInRegex](/linter/rules/no-useless-backref-in-regex) (inspired) |
### eslint-plugin-solid
