...
| ---- | ---- |
| [font-family-fallbacks](https://github.com/eslint/css/blob/main/docs/rules/font-family-fallbacks.md) |[useGenericFontNames](/linter/rules/use-generic-font-names) (inspired) |
| [no-duplicate-imports](https://github.com/eslint/css/blob/main/docs/rules/no-duplicate-imports.md) |[noDuplicateAtImportRules](/linter/rules/no-duplicate-at-import-rules) (inspired) |
...
| [no-invalid-at-rule-placement](https://github.com/eslint/css/blob/main/docs/rules/no-invalid-at-rule-placement.md) |[noInvalidPositionAtImportRule](/linter/rules/no-invalid-position-at-import-rule) (inspired) |
| [no-invalid-at-rules](https://github.com/eslint/css/blob/main/docs/rules/no-invalid-at-rules.md) |[noUnknownAtRules](/linter/rules/no-unknown-at-rules) (inspired) |
...
| [no-invalid-properties](https://github.com/eslint/css/blob/main/docs/rules/no-invalid-properties.md) |[noUnknownProperty](/linter/rules/no-unknown-property) (inspired) |
| [no-unmatchable-selectors](https://github.com/eslint/css/blob/main/docs/rules/no-unmatchable-selectors.md) |[noUnmatchableAnbSelector](/linter/rules/no-unmatchable-anb-selector) (inspired) |
