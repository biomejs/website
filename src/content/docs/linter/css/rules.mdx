...
| Rule name | Description | Properties |
| --- | --- | --- |
| [noImportantStyles](/linter/rules/no-important-styles) | Disallow the use of the `!important` style. | <span class='inline-icon' title="The rule has an unsafe fix" ><Icon name="warning" label="The rule has an unsafe fix" size="1.2rem" /></span> |
| [noUnknownAtRule](/linter/rules/no-unknown-at-rule) | Disallow unknown at-rules. |  |
