...
| [noInvalidPropertyInitValue](/linter/rules/no-invalid-property-init-value) | Checks that the `initial-value` of an `@property` rule follows the value format declared by its `syntax`. | <span class='inline-icon' title="This rule is not released yet"><Icon name="moon" label="This rule is not released yet" size="1.2rem" /></span> |
...
| Rule name | Description | Properties |
| --- | --- | --- |
| [noDeprecatedMediaType](/linter/rules/no-deprecated-media-type) | Disallow deprecated media types. | <span class='inline-icon' title="This rule is recommended" ><Icon name="approve-check-circle" size="1.2rem" label="This rule is recommended" /></span> |
