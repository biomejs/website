...
| [noExcessiveSelectorClasses](/linter/rules/no-excessive-selector-classes) | Limit the number of classes in a selector. | <span class='inline-icon' title="This rule is not released yet"><Icon name="moon" label="This rule is not released yet" size="1.2rem" /></span> |
