...
| Rule name | Description | Properties |
| --- | --- | --- |
| [noImportantStyles](/linter/rules/no-important-styles) | Disallow the use of the `!important` style. | <span class='inline-icon' title="The rule has an unsafe fix" ><Icon name="warning" label="The rule has an unsafe fix" size="1.2rem" /></span><span class='inline-icon' title="This rule is only available in beta"><Icon name="moon" label="This rule is only available in beta" size="1.2rem" /></span> |
| [noUnknownAtRule](/linter/rules/no-unknown-at-rule) | Disallow unknown at-rules. | <span class='inline-icon' title="This rule is only available in beta"><Icon name="moon" label="This rule is only available in beta" size="1.2rem" /></span> |
...
- [noMissingVarFunction](/linter/rules/no-missing-var-function) (Severity: Error)
...
- [noUnknownPseudoClass](/linter/rules/no-unknown-pseudo-class) (Severity: Error)
- [noUnknownPseudoElement](/linter/rules/no-unknown-pseudo-element) (Severity: Error)
- [noUnknownTypeSelector](/linter/rules/no-unknown-type-selector) (Severity: Error)
...
- [noDescendingSpecificity](/linter/rules/no-descending-specificity) (Severity: Warning)
- [noDuplicateAtImportRules](/linter/rules/no-duplicate-at-import-rules) (Severity: Error)
- [noDuplicateCustomProperties](/linter/rules/no-duplicate-custom-properties) (Severity: Error)
- [noDuplicateFontNames](/linter/rules/no-duplicate-font-names) (Severity: Error)
- [noDuplicateProperties](/linter/rules/no-duplicate-properties) (Severity: Error)
- [noDuplicateSelectorsKeyframeBlock](/linter/rules/no-duplicate-selectors-keyframe-block) (Severity: Error)
- [noEmptyBlock](/linter/rules/no-empty-block) (Severity: Warning)
