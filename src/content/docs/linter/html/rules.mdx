...
| [noDuplicateAttributes](/linter/rules/no-duplicate-attributes) | Disallow duplication of attributes. | <span class='inline-icon' title="This rule is not released yet"><Icon name="moon" label="This rule is not released yet" size="1.2rem" /></span> |
