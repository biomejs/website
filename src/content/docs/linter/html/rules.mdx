...
| Rule name | Description | Properties |
| --- | --- | --- |
| [noScriptUrl](/linter/rules/no-script-url) | Disallow `javascript:` URLs in HTML. | <span class='inline-icon' title="This rule is not released yet"><Icon name="moon" label="This rule is not released yet" size="1.2rem" /></span> |
