...
| [useVueValidVText](/linter/rules/use-vue-valid-v-text) | Enforce valid `v-text` Vue directives. | <span class='inline-icon' title="This rule is not released yet"><Icon name="moon" label="This rule is not released yet" size="1.2rem" /></span> |
## Recommended rules 
