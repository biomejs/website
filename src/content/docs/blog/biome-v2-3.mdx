...
```
:::note
We plan to fade out this option and make it the default. The option will be removed once the HTML parser becomes stable supports more language-specific features.
:::
...
More features and fixes have been shipped, like React v19 support, `baseUrl` support inside `tsconfig.json`, and moore. Refer to the changelog page for a [detailed breakdown of the features](/internals/changelog/version/2-3-0/).
