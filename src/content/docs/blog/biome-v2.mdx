...
Props to <Avatar handle="nhedger" /> for authoring the [GitHub Action](https://github.come/biomejs/setup-biome), and [shipping](// todo link to blog post) the new version of the [VS Code extension](https://marketplace.visualstudio.com/items?itemName=biomejs.biome).
