...
- **`stylelint`** &mdash;
  Intenta encontrar el archivo de configuración de Stylelint en el directorio de trabajo y, como resultado, actualiza el archivo de configuración del bioma.
...
**Uso**: **`biome`** **`migrate`** **`stylelint`** \[**`--include-inspired`**\] \[**`--include-nursery`**\]

**Opciones disponibles:**

- **`    --include-inspired`** &mdash;
  Incluye reglas inspiradas en una regla stylelint en la migración
- **`    --include-nursery`** &mdash;
  Incluye normas de guardería en la migración
- **`-h`**, **`--help`** &mdash;
  Imprime información de ayuda
