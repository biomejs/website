...
:::tip
If you're updrading from the `2.x` version of the extension, checkout the [migration instructions](#migrating-from-the-2x-extension) at the end of this document.
:::
