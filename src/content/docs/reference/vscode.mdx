...
The extension is always enabled because it needs to keep track of the state of the workspace, however it provides two settings
...
Run either of the following commands from the [command palette](https://code.visualstudio.com/docs/getstarted/userinterface#_command-palette):
