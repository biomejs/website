...
```shell
biome ci --formatter-enabled=true
```
...
<h3 id="daemon-flags">Daemon server flags</h3>
...
<span id="json-parser-flags"></span>

<h3 id="parser-flags">Parser flags</h3>
...
<h3 id="logging-flags">Logging flags</h3>

These flags configure internal CLI or daemon server logging. Each flag description identifies which commands use that flag.
