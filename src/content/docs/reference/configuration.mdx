...
Whether Biome should use the project's VCS ignore file. When `true`, Biome will ignore the files
specified in the VCS ignore file as well as those specified in a `.ignore` file.
