...
Enables the parsing of frontmatter in Markdown files. When enabled, the leading `---` is considered the opening fence of the frontmatter. Default to `false`.
...
- `"alwys"`: Biome attempts to fit the paragraph in the configured `lineWidth`
