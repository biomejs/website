...
It will include the options of [top level formatter](#formatter) configuration, minus `includes`.
...
It will include the options of [top level linter](#linter) configuration, minus `includes`.
...
It will include the options of [top level assist](#assist), minus `includes`.
