...
All these change can lead to different sorting of the imports and exports of your project.
...
One significant difference between the old and new default sorters is that Node.js without the `node:` protocol are no longer placed before other imports.
