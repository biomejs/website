...
banner:
    content: |
        Biome <strong>v2 beta</strong> is now <a href="/blog/biome-v2-0-beta/">available</a> 🚀. Learn more by browsing the <a href="https://next.biomejs.dev/guides/getting-started/">new documentation</a>.
