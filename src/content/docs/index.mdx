...
<div class="hero-code">
    ...
    **Biome is a [performant linter](https://github.com/biomejs/biome/tree/main/benchmark#linting)** for _JavaScript_, _TypeScript_, and _JSX_ that features **[<NumberOfRules/> rules](/linter/rules/)** from ESLint, TypeScript ESLint, and [other sources](/linter/rules-sources/).
