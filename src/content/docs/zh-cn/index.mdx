...
<div class="hero-code">
    ...
    Biome 是一个适用于 _JavaScript_、_TypeScript_ 和 _JSX_ 的[**高性能 linter**](https://github.com/biomejs/biome/tree/main/benchmark#linting)，拥有来自 ESLint、typescript-eslint 以及[其它规则源](https://github.com/biomejs/biome/discussions/3)的[超过 200 条规则](/zh-cn/linter/rules/)。
