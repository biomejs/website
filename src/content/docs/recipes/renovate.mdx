...
Renovate has a [shared preset rule](https://docs.renovatebot.com/presets-regexManagers/#regexmanagersbiomeversions) that can help keep the `$schema` version in-sync and up-to-date within the `biome.json` configuration file.
