...
- [VS Code](/ja/editors/first-party-extensions#vs-code)
- [IntelliJ](/ja/editors/first-party-extensions#intellij)
- [Zed](/ja/editors/first-party-extensions#zed)

**Vim**、**Neovim**、**Sublime Text**などの他のエディタ向けの[コミュニティ拡張機能](/ja/editors/third-party-extensions)もあります。
