...
多くのBiome リンタのルールはESLintやESLintのプラグインのルールからインスパイアされて作られています。Biomeには[TypeScript ESLint](https://typescript-eslint.io/)、[ESLint JSX A11y](https://github.com/jsx-eslint/eslint-plugin-jsx-a11y)、[ESLint React](https://github.com/jsx-eslint/eslint-plugin-react)、[ESLint Unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn)などのESLintプラグインのルールがあります。
...
BiomeはPrettier フォーマッタとできるだけ近い動作をするようにしています。
