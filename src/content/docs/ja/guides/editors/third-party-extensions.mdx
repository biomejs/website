...
- [`vim`](https://www.vim.org/): [`ALE`](https://github.com/dense-analysis/ale) がBiomeをサポートしています。インストール手順に従ってください。
- [`neovim`](https://neovim.io/): [`nvim-lspconfig`](https://github.com/neovim/nvim-lspconfig/) をインストールし、[指示](https://github.com/neovim/nvim-lspconfig/blob/master/doc/configs.md#biome)に従ってください。また、[`ALE`](https://github.com/dense-analysis/ale) もBiomeをサポートしています。
...
Helix 23.10では[複数の言語サーバーのサポート](https://github.com/helix-editor/helix/pull/2507)が追加されました。これにより、`typescript-language-server` とBiomeを併用できます。
