...
<div class="hero-code">
    ...
    **Biomeは _JavaScript_、_TypeScript_、_JSX_、_CSS_ そして _GraphQL_ のための[高性能なリンタ](https://github.com/biomejs/biome/tree/main/benchmark#linting)** であり、ESLint、TypeScript ESLint、[その他のソース](/linter/rules-sources/)に由来する **[<NumberOfRules/>個のルール](/linter/)** を備えています。
