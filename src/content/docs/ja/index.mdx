...
<div class="hero-code">
    ...
    **Biomeは _JavaScript_、_TypeScript_ そして _JSX_ のための[高性能なlinter](https://github.com/biomejs/biome/tree/main/benchmark#linting)** であり、ESLint、typescript-eslint、[その他のソース](https://github.com/biomejs/biome/discussions/3)に由来する **[200以上のルール](/linter/rules/)** を備えています。
