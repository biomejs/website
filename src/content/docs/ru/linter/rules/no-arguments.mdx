...
title: noArguments
description: Запрещает использование arguments
---
...
- Diagnostic Category: [`lint/complexity/noArguments`](/ru/reference/diagnostics#diagnostic-category)
...
```
## Описание
Запрещает использование `arguments`.
