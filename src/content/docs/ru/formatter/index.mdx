...
Biome - это опинионный форматировщик, который [поддерживает несколько языков](/ru/internals/language-support).
...
Для получения дополнительной информации обо всех доступных опциях см. [справочник по CLI](/ru/reference/cli#biome-format).
...
Опции форматировщика могут быть установлены через [CLI](/ru/reference/cli/#biome-format) или через [конфигурационный файл Biome](/ru/guides/configure-biome).
Начиная с версии v1.9, Biome поддерживает загрузку файлов `.editorconfig`.

Рекомендуется использовать [конфигурационный файл Biome](/ru/guides/configure-biome), чтобы убедиться, что и Biome CLI, и Biome LSP применяют одинаковые опции.
...
Подробнее см. в [справочнике по конфигурации](/ru/reference/configuration#formatter).
...
Однако вы можете [игнорировать файл, используя конфигурационный файл Biome](/ru/guides/configure-biome/#ignore-files).
