---
title: Репортеры
description: Управление выводом Biome с помощью репортеров
---

CLI Biome принимает аргумент `--reporter`, который позволяет изменять способ вывода диагностики и сводки в терминал.
...
```
reporter/parse ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  i Следующие файлы содержат ошибки парсинга.

  - index.css

reporter/format ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  i Следующие файлы необходимо отформатировать.
...
reporter/violations ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  i Некоторые правила линтера или действия помощника сообщили о нарушениях.
...
:::caution
Этот репортер является экспериментальным и может изменяться в минорных релизах.
:::

Он выводит сводку и диагностику в формате JSON.
...
Аналогично `--reporter=json`, он выводит сводку и диагностику в формате JSON, и вывод форматируется с использованием текущих опций форматирования JSON (файл конфигурации или значения по умолчанию).
...
Используйте этот репортер в GitHub workflow. При правильной настройке в PR workflow, GitHub будет выводить сообщение для каждой info/warning/error.
...
Используйте этот репортер для вывода диагностики в формате [Checkstyle](https://checkstyle.org/).
...
Используйте этот репортер для вывода диагностики в формате [RDJSON](https://deepwiki.com/reviewdog/reviewdog/3.2-reviewdog-diagnostic-format).
