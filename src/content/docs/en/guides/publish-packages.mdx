...
description: Learn how to publish Biome plugins and configurations as packages.
---
...
<Steps>
 ...
 :::tip
 We strongly suggest adding the `biome-plugin` keyword to your `package.json`, this will help discovering your package:

 ```json title="package.json" ins={11-13} ins="biome-plugin"
 {
   "name": "@org/biome-configs",
   "version": "1.0.0",
   "files": [
