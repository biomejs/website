...
| --- | --- | --- |
| [useSortedEnumMembers](/assist/actions/use-sorted-enum-members/graphql) | Sort the members of an enum in natural order. | <span class='inline-icon' title='The rule has a safe fix.'><Icon name="seti:config" label="The rule has a safe fix" size="1.2rem"  /></span> |
| [useSortedSelectionSet](/assist/actions/use-sorted-selection-set/graphql) | Sort GraphQL selection sets. | <span class='inline-icon' title="The rule has an unsafe fix" ><Icon name="warning" label="The rule has an unsafe fix" size="1.2rem" /></span> |
| [useSortedTypeFields](/assist/actions/use-sorted-type-fields/graphql) | Sort fields in GraphQL type definitions alphabetically. | <span class='inline-icon' title='The rule has a safe fix.'><Icon name="seti:config" label="The rule has a safe fix" size="1.2rem"  /></span> |
## Recommended actions 
