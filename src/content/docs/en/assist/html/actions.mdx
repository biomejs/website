...
| --- | --- | --- |
| [noDuplicateClasses](/assist/actions/no-duplicate-classes/html) | Remove duplicate CSS classes. | <span class='inline-icon' title='The rule has a safe fix.'><Icon name="seti:config" label="The rule has a safe fix" size="1.2rem"  /></span> |
| [useSortedAttributes](/assist/actions/use-sorted-attributes/html) | Enforce attribute sorting in HTML elements. | <span class='inline-icon' title='The rule has a safe fix.'><Icon name="seti:config" label="The rule has a safe fix" size="1.2rem"  /></span> |
## Recommended actions 
