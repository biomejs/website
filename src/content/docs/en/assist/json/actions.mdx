...
| --- | --- | --- |
| [useSortedKeys](/assist/actions/use-sorted-keys/json) | Sort the keys of a JSON object in natural order. | <span class='inline-icon' title='The rule has a safe fix.'><Icon name="seti:config" label="The rule has a safe fix" size="1.2rem"  /></span> |
| [useSortedPackageJson](/assist/actions/use-sorted-package-json/json) | Organize package.json fields according to established conventions. | <span class='inline-icon' title='The rule has a safe fix.'><Icon name="seti:config" label="The rule has a safe fix" size="1.2rem"  /></span> |
## Recommended actions 
