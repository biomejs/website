...
title: useConsistentArrayType (JavaScript)
description: JavaScript (and super languages) documentation for useConsistentArrayType
localized: false
---
import RuleLanguageLinks from "@/components/RuleLanguageLinks.astro";
import RulePlaygroundLink from "@/components/RulePlaygroundLink.astro";

<RuleLanguageLinks current="javascript" languages={[{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/use-consistent-array-type/javascript/"}]} />
...
- <RulePlaygroundLink rule="useConsistentArrayType" category="lint" language="ts" code={"let invalid: Array<foo>;\n"} />
