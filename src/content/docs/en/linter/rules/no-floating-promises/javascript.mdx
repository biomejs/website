...
title: noFloatingPromises (JavaScript)
description: JavaScript (and super languages) documentation for noFloatingPromises
localized: false
---
import RuleLanguageLinks from "@/components/RuleLanguageLinks.astro";
import RulePlaygroundLink from "@/components/RulePlaygroundLink.astro";

<RuleLanguageLinks current="javascript" languages={[{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/no-floating-promises/javascript/"}]} />
...
- <RulePlaygroundLink rule="noFloatingPromises" category="lint" language="ts" code={"async function returnsPromise(): Promise<string> {\n  return 'value';\n}\nreturnsPromise().then(() => {});\n"} />
