...
- <RulePlaygroundLink rule="noNextAsyncClientComponent" category="lint" language="jsx" code={"\"use client\";\n\nexport default async function MyComponent() {\n  return <div>Hello</div>;\n}\n"} />
