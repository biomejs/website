...
title: noUnsafeDeclarationMerging (JavaScript)
description: JavaScript (and super languages) documentation for noUnsafeDeclarationMerging
localized: false
---
import RuleLanguageLinks from "@/components/RuleLanguageLinks.astro";
import RulePlaygroundLink from "@/components/RulePlaygroundLink.astro";

<RuleLanguageLinks current="javascript" languages={[{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/no-unsafe-declaration-merging/javascript/"}]} />
...
- <RulePlaygroundLink rule="noUnsafeDeclarationMerging" category="lint" language="ts" code={"interface Foo {\n    f(): void\n}\n\nclass Foo {}\n\nconst foo = new Foo();\nfoo.f(); // Runtime Error: Cannot read properties of undefined.\n"} />
