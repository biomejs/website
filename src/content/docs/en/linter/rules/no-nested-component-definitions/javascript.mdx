...
title: noNestedComponentDefinitions (JavaScript)
description: JavaScript (and super languages) documentation for noNestedComponentDefinitions
localized: false
---
import RuleLanguageLinks from "@/components/RuleLanguageLinks.astro";
import RulePlaygroundLink from "@/components/RulePlaygroundLink.astro";

<RuleLanguageLinks current="javascript" languages={[{"id":"javascript","label":"JavaScript (and super languages)","href":"/linter/rules/no-nested-component-definitions/javascript/"}]} />
...
- <RulePlaygroundLink rule="noNestedComponentDefinitions" category="lint" language="jsx" code={"function ParentComponent() {\n  function ChildComponent() {\n    return <div>Hello</div>;\n  }\n\n  return <ChildComponent />;\n}\n"} />
