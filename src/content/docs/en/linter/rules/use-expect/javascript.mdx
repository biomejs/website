...
- <RulePlaygroundLink rule="useExpect" category="lint" language="js" code={"test(\"no assertion\", async ({ page }) => {\n    await page.goto(\"/\");\n    await page.click(\"button\");\n});\n"} />
