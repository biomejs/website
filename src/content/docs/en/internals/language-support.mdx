...
| YAML                                              | <span aria-label="Supported" role="img">✅️</span>    | <span aria-label="Supported" role="img">✅️</span>    | <span aria-label="Supported" role="img">✅️</span>       | <span aria-label="Not in Progress" role="img">🚫</span> |
...
| [Markdown](#markdown)                             | <span aria-label="Supported" role="img">✅️</span>    | <span aria-label="Supported" role="img">✅️</span>    | <span aria-label="Supported" role="img">✅️</span>       | <span aria-label="Not in Progress" role="img">🚫</span> |
...
Biome supports the [CommonMark](https://commonmark.org/) specification plus [GitHub-Flavored Markdown](https://github.github.com/gfm/) by default.

When `markdown.parser.frontmatter` is enabled, Biome will format and analyze the frontmatter as YAML.
...
Biome will use the info string of the fenced code blocks as "file extension", and will analyze and format them. If Biome can't recognise
the info string a file extension, they will be ignored.

````diff title="file.md" ins="js"
```js
-function name () {
-     return "Lorem ispsum"
-}
...
Quoted fenced code blocks are intentionally ignored.
